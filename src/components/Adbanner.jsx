...
export const TopBannerAd = () => {
    return (
        <div style={{
            ...
            boxShadow: '0 0 15px rgba(102,126,234,0.6), 0 0 30px rgba(118,75,162,0.5)',
            overflow: 'hidden',
            position: 'relative',
        }}>
            {/* Decorative elements */}
...
export const MidBannerAd = () => {
    return (
        <div style={{
            ...
            padding: '1.5rem',
            border: '1px solid rgba(255,255,255,0.35)',
            boxShadow: '0 0 20px rgba(240,147,251,0.45), 0 0 35px rgba(245,87,108,0.35)',
            position: 'relative',
            overflow: 'hidden',
            textAlign: 'center',
        }}>
...
export const MiddleBannerAd = () => {
    return (
        <div style={{
            ...
            padding: '0 2rem',
            border: '1px solid rgba(255,255,255,0.35)',
            boxShadow: '0 0 15px rgba(67,233,123,0.45), 0 0 30px rgba(56,249,215,0.35)',
            overflow: 'hidden',
            position: 'relative',
        }}>
            {/* Decorative elements */}
...
export const FooterBannerAd = () => {
    return (
        <div style={{
            ...
            padding: '2rem 3rem',
            border: '1px solid rgba(255,255,255,0.35)',
            boxShadow: '0 0 20px rgba(79,172,254,0.45), 0 0 35px rgba(0,242,254,0.35)',
            position: 'relative',
            overflow: 'hidden',
        }}>
